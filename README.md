...
Study of Machine Learning. This book contains PART A and PART B. PART A Explains the Fundamentals of Machine Learning.
...
+ *Section 10 : Introduction to Artificial Neural Networks with Keras.*
    ...
    + Regression MLPs.
    + Classification MLPs.
    + Building an Image Classifier using Sequnetial API
